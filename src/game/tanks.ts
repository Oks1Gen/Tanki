...
export const TANK_SPECS: Record<TankModel, TankSpec> = {
  e100: {
    ...
    maxSpeed: 9, rotSpeed: 0.75, turretRotSpeed: 1.0, reloadTime: 3.4, shellSpeed: 70, damage: 190, maxHealth: 2900,
  },
  t34: {
    ...
    maxSpeed: 16, rotSpeed: 1.5, turretRotSpeed: 2.1, reloadTime: 2.1, shellSpeed: 88, damage: 120, maxHealth: 1500,
  },
  t100lt: {
    ...
    maxSpeed: 27, rotSpeed: 2.1, turretRotSpeed: 3.1, reloadTime: 1.35, shellSpeed: 102, damage: 85, maxHealth: 950,
  },
};
